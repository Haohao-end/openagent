        ...
        "list": [
            {
                ...
                "description": "这是专门用来存储LLMOps课程信息的知识库",
                "document_count": 13,
                "icon": "https://haohao-llmops-1257184990.cos.ap-guangzhou.myqcloud.com/2024/04/07/96b5e270-c54a-4424-aece-ff8a2b7e4331.png",
...
- **响应示例**：
  ...
  ```json
  {
      ...
      "data": {
          ...
          "name": "LLMOps聊天机器人",
          "icon": "https://haohao-llmops-1257184990.cos.ap-guangzhou.myqcloud.com/2024/04/23/e4422149-4cf7-41b3-ad55-ca8d2caa8f13.png",
...
- **请求示例**：
  ...
  {
  	"name": "LLM应用产品经理",
  	"icon": "https://cdn.haohao.com/2024/05/14/218e5217-ab10-4634-9681-022867955f1b.png",
          ...
          "datasets": [
              {
                  ...
                  "name": "Prompt提示词大全",
                  "icon": "https://haohao-llmops-1304251364.cos.ap-guangzhou.myqcloud.com/2024/10/27/67c94d7b-c503-4528-87c4-1810c17689b1.jpg"
              },
              {
                  "id": "f3f28f75-8e60-4eba-b6df-4d1b390bbd89",
                  "name": "LLMOps项目",
                  "icon": "https://haohao-llmops-1304251364.cos.ap-guangzhou.myqcloud.com/2024/09/29/9f5e42d4-e184-4e2c-88f2-0ef843749e3f.jpg"
              }
          ],
          "retrieval_config": {
          ...
          "list": [
              {
                  ...
                  "name": "高德工具包",
                  "icon": "https://cdn.haohao.com/gaode.png",
...
- **请求示例**：
  ...
  {
      "name": "谷歌搜索",
      "icon": "https://cdn.haohao.com/google.png",
...
- **响应示例**：
  ...
  ```json
  {
      "code": "success",
      "data": {
          "image_url": "https://cdn.haohao.com/2024/05/14/218e5217-ab10-4634-9681-022867955f1b.png"
      },
      "message": ""
  }
  ```
          ...
          "list": [
              {
                  "id": "46db30d1-3199-4e79-a0cd-abf12fa6858f",
                  "name": "LLMOps知识库",
                  "icon": "https://cdn.haohao.com/dataset.png",
...
- **请求示例**：
  ...
  {
      "name": "LLMOps知识库",
      "icon": "https://cdn.haohao.com/dataset.jpg",
...
- **响应示例**：
  ...
  ```json
  {
      ...
      "data": {
          ...
          "name": "泽辉呀",
          "email": "zehuiya@163.com",
          "avatar": "https://cdn.haohao.com/2024/05/14/218e5217-ab10-4634-9681-022867955f1b.png",
